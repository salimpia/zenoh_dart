...
set(ZENOHC_BUILD_WITH_UNSTABLE_API ON)
set(ZENOHC_BUILD_WITH_SHARED_MEMORY ON)
...
if(NOT TARGET __zenohc_shared)
    ...
    set_target_properties(__zenohc_shared PROPERTIES
        ...
        IMPORTED_LOCATION "${PACKAGE_PREFIX_DIR}/lib/libzenohc.dylib"
...
if(NOT TARGET __zenohc_static)
    ...
    target_link_libraries(__zenohc_static INTERFACE /Applications/Xcode_16.4.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/System/Library/Frameworks/Foundation.framework;/Applications/Xcode_16.4.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/System/Library/Frameworks/Security.framework)
